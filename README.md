...
| onTriggerOutside   | `Function`                       |          | If `react-tiny-popover` detects that the trigger (child) has started to interact with the boundary element. You may handle this event here, in the form of `() => void`. This behavior con be configured by using the `intersectInset` and `intersectThreshold` properties.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
| intersectInset     | `number`                         |          | This property determines how much padding is considered when computing wether the trigger has started to intersect with the boundary element. For example, when the value is set to 10 and the trigger is 10 pixels away from the edge of the boundary element, the `onTriggerOutside` function will be called.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| intersectThreshold | `number`                         |          | This property is a relative value between 0.0 and 1.0 and specifies how much percent of the trigger element has to be outside the bounds of the boundary element before it is considered to be outside. By default, the value is 1.0 meaning that the whole element has to be outside the bounds for the `onTriggerOutside` function to be called. On the other hand, a value of 0.0 means that the trigger is consider outside already once it starts to intersect with the edge of the boundary element.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
